        ...
        <Layout>
            ...
            <div className="rp-box">
                ...
                <div className="flex items-center mt-2">
                    <input
                        className="w-[240px] h-6 rounded-lg bg-white text-[#333] text-[15px] border-none outline-none px-2"
                        type="text"
                        value={window.location.href}
                    />
                    <button className="h-full ml-2 px-1 rounded-md bg-[#007BFF] text-xs block">
                        Coppy
                    </button>
                </div>
            </div>
