        ...
        <Layout>
            ...
            <div className="w-[280px] h-[280px] m-auto flex justify-center items-center mt-8 text-white">
                <div className="relative">
                    <div className="absolute flex flex-col items-center text-white text-2xl font-bold left-[calc(50%+4px)] top-1/3 -translate-x-1/2 -translate-y-1/2">
                        <div className="flex items-baseline">
                            <span>{name1}</span>
                            <span className="mx-7 text-xl">&</span>
                            <span>{name2}</span>
                        </div>
                        <span>{Math.ceil(Math.random() * 30) + 70}%</span>
                    </div>
