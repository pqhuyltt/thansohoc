        ...
        <Layout>
            ...
            <div className="w-[280px] h-[280px] m-auto flex justify-center items-center mt-8 text-white">
                <div className="relative">
                    <div className="absolute animate-scale-heart flex flex-col items-center text-white text-2xl font-bold left-[calc(50%+4px)] top-[43%] -translate-x-1/2 -translate-y-1/2">
                    ...
                    <FaRegHeart className="text-[180px] text-[#FD6A78]  " />
                    <div
                        style={{ height: `${percent}%` }}
                        className="bg-[#DC3545] absolute bottom-0 left-0 right-0 z-[-1]"
                    ></div>
                </div>
            </div>
