...
const Home = () => {
    ...
    const handleSearch = () => {
        ...
        if (input.withLove) {
            ...
            const month = Number(input.month2)
            const year = input.year2 as string
        ...
        <Layout>
            ...
            <div className="mt-4">
                ...
                <div className="rounded-lg bg-[rgba(0,0,0,.4)] p-4">
                    ...
                    <div className=" rounded-lg border txt-gradient border-white text-white text-sm font-bold  p-2 w-full lg:w-1/2 mt-4">
                        <span
